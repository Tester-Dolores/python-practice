...
foods = ["番茄汤冒菜","蛋炒饭","亲爱的麻辣烫","烤肉饭","皮蛋瘦肉粥","炒河粉","螺蛳粉","螺蛳粉+奶茶","番茄汤冒菜+奶茶","蛋炒饭+奶茶","亲爱的麻辣烫+奶茶","烤肉饭+奶茶","炒河粉+奶茶"]
...
for i in range(0,5):
	...
	if spicyfood == 1 and random_food == "螺蛳粉" and milk_tea !=2: foods.remove("螺蛳粉+奶茶")
	if spicyfood == 1 and random_food == "螺蛳粉+奶茶": foods.remove("螺蛳粉")